...
const Hero = () => {
  ...
  return (
    ...
    <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
      ...
      <div className='flex flex-col justtify-center items-center mt-5'>
    ...
    <div className={`absolute w-full ${isMobile ? 'bottom-40' : 'bottom-10'} flex justify-center items-center`}>
    <a href='#about'>
